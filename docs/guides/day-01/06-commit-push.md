...
Day 1 gồm nhiều việc khác loại. Thay vì một commit khổng lồ, tách 2–3 commit theo nhóm việc — lịch sử git sẽ kể câu chuyện rõ ràng cho người đọc (gồm cả nhà tuyển dụng đọc `git log`). Gợi ý nhóm:
